...
const Header = ({toggle}) => {
    return (
        <nav className={`bg-white flex ${toggle ? 'w-[calc(100vw-5rem)]':'w-[calc(100vw-13rem)]'} items-center px-4 py-2 md:px-8 md:py-3 gap-x-4 shadow-md justify-between fixed top-0 z-30`}>
<div className='flex gap-4'>
            <p className="text-xl font-medium max-sm:text-sm">Payments</p>
            <div className="hidden md:flex items-center space-x-2.5 ">
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_13012_2522)">
                    ...
                    <defs>
                        <clipPath id="clip0_13012_2522">
                            <rect width="14" height="14" fill="white" />
                        </clipPath>
                    </defs>
                </svg>

                <small className="text-xs text-gray-600 hover:underline hover:cursor-help max-sm:text-[8px] max-sm:hidden">
                    How it works
                </small>
            </div>
            </div>
            <div className="flex items-center space-x-2 px-2 py-1.5 bg-gray-200 rounded-md max-sm:px-2 max-sm:py-1.5 max-sm:grow-0 max-sm:space-x-1.5 w-1/2 ">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_13012_2526)">
                ...
                <input
                    className="grow text-sm outline-none bg-transparent placeholder-gray-500 max-sm:text-xs"
                    placeholder="Search features, tutorials, etc."
                />
            </div>
            <section className="flex space-x-3 items-center">
                <div className="p-3 bg-gray-200 rounded-full hover:cursor-pointer">
                ...
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_13012_2537)">
